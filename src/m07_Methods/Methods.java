...
public class Methods {
    public static void main() {
        ...
        //Con un parámetro
        sendEmailToUser("jmotoso001@gmail.com");

        //Varios parámetros
        sendEmailToUser("jmotoso001@gmail.com", "Josu");

        var users = new ArrayList<>(Arrays.asList("jmotoso001@gmail.com", "juan@gmail.com"));
        sendEmailToUser(users);

        var state = sendEmailWithState("jmotoso001@gmail.com");
